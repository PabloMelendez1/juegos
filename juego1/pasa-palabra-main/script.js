...
const bd_juego = [
  {
      id:'A',
      pregunta:"Una marca gráfica que se coloca sobre una letra para indicar que debe ser pronunciada con mayor intensidad que las demás",
      respuesta:"acento"
  },
  {
    id:'B',
    pregunta:"Que habla dos idiomas",
    respuesta:"bilingue"
  },
  {
    id:'C',
    pregunta:"Efecto acústico desagradable que resulta de la combinación de sonidos poco armónicos o de la repetición exagerada de un mismo sonido en una frase.",
    respuesta:"cacofonía"
  },
  {
    id:'D',
    pregunta:"Grupo de dos vocales distintas y contiguas que se pronuncian en una sola sílaba.",
    respuesta:"cacofonía"
  },
  {
    id:'E',
    pregunta:"Que lleva el acento en la antepenúltima sílaba",
    respuesta:"esdrújula"
  },
  {
    id:'F',
    pregunta:"Unidad fonológica mínima que resulta de la abstracción o descripción teórica de los sonidos de la lengua.",
    respuesta:"fonema"
  },
  {
    id:'G',
    pregunta:"Que expresa el origen geográfico o racial.",
    respuesta:"gentilicio"
  },
  {
    id:'H',
    pregunta:"la secuencia de dos vocales que se encuentran juntas pero pertenecen a diferentes sílabas",
    respuesta:"Hiato"
  },
  {
    id:'I',
    pregunta:"herramienta de consulta que se utiliza para encontrar rápidamente las palabras que se desean escribir correctamente.",
    respuesta:"Índice ortográfico"
  },
  {
    id:'J',
    pregunta:" Lenguaje coloquial o técnico que se utiliza en un grupo social determinado y que no es comprendido por todos los hablantes del idioma.",
    respuesta:"jerga"
  },
]
